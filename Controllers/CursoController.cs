...
namespace WebEscuela.Controllers
{
    public class CursoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EscuelaId,Nombre,Jornada,Direccion")] Curso curso)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("EscuelaId,Nombre,Jornada,Direccion, Id")] Curso curso)
        {
            if (id != curso.Id)
            {
                return NotFound();
        ...
        public IActionResult PrintPdf()
        {
            ...
            return new ViewAsPdf("PrintPdf", _context.Cursos.Include(es => es.Escuela))
            {
