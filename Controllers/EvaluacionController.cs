...
namespace WebEscuela.Controllers
{
    public class EvaluacionController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("AlumnoId,AsignaturaId,Nota,Nombre, Id")] Evaluacion evaluacion)
        {
            if (id != evaluacion.Id)
            {
                return NotFound();
        ...
        public IActionResult PrintPdf()
        {
            ...
            return new ViewAsPdf("PrintPdf", _context.Evaluaciones.Include(a => a.Alumno).Include(asi => asi.Asignatura))
            {
