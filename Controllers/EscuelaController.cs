...
namespace WebEscuela.Controllers
{
    public class EscuelaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Fundacion,AtributoTipoDeEscuela,Direccion,Nombre")] Escuela escuela)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Fundacion,AtributoTipoDeEscuela,Direccion,Nombre, Id")] Escuela escuela)
        {
            if (id != escuela.Id)
            {
                return NotFound();
        ...
        public IActionResult PrintPdf()
        {
            ...
            return new ViewAsPdf("PrintPdf", _context.Escuelas)
            {

                PageSize = Rotativa.AspNetCore.Options.Size.A4,
                FileName = "Escuelas.pdf",
